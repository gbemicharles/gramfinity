...
const INITIAL_TOKENS = {
  ...
  NOT: {
    ...
    image: "https://assets.coingecko.com/coins/images/37855/large/notcoin.png",
    price: 0.0125,
    change1h: -1.24,
    change24h: 8.42,
    volume24h: 89340200,
  ...
  DOGS: {
    ...
    image: "https://assets.coingecko.com/coins/images/39563/large/dogs.png",
    price: 0.00085,
    change1h: 2.14,
    change24h: -12.35,
    volume24h: 145200300,
  ...
  HMSTR: {
    ...
    image: "https://assets.coingecko.com/coins/images/39209/large/hamster.png",
    price: 0.0035,
    change1h: -0.15,
    change24h: -4.82,
    volume24h: 98120000,
  ...
  GRAM: {
    ...
    image: "https://raw.githubusercontent.com/telegramdesktop/tdesktop/dev/Telegram/Resources/art/icon256.png",
    price: 0.0092,
    change1h: 0.85,
    change24h: 1.15,
    volume24h: 3120500,
  ...
  REDO: {
    ...
    image: "https://assets.coingecko.com/coins/images/37392/large/redo.png",
    price: 0.854,
    change1h: 3.45,
    change24h: 14.82,
    volume24h: 12450300,
  ...
  TONY: {
    ...
    image: "https://api.dicebear.com/7.x/identicon/svg?seed=TONY",
    price: 0.000045,
    change1h: 14.25,
    change24h: 128.50,
    volume24h: 4200150,
  ...
  KOTE: {
    symbol: "KOTÉ",
    name: "Koté Cat",
    address: "EQB_kote_cat_graduated_bond_ton",
    image: "https://api.dicebear.com/7.x/identicon/svg?seed=KOTE",
    price: 0.00012,
    change1h: 6.80,
    change24h: 84.20,
    volume24h: 189500,
    ...
    buySellRatio: 0.65,
    holdersGrowth: 18.2,
    initialLiquidity: 85000,
    devWallet: "EQB_Kote_Dev_Cat_4421",
    launchTime: Date.now() - 120 * 60 * 1000, // 2 hours ago
    category: "Meme",
    logoBg: "linear-gradient(135deg, #eab308, #854d0e)",
    socialLinks: { telegram: "https://t.me/kote_cat", x: "https://x.com/kote_cat", website: "https://kote.xyz" },
    liquidity: 145000,
    supply: 1000000000,
    holders: 3820,
    security: { rugScore: 0, rugRisk: "Safe", verified: true, renounced: true, lockedLiquidity: 100 },
    ...
    bondingProgress: 100,
    isDex: true,
    description: "Viral Telegram cat meme token that successfully hit 100% bonding and graduated to STON.fi DEX."
  },
  HONK: {
    symbol: "HONK",
    name: "Honk Honkler",
    address: "EQD_honk_clown_gaspump_token",
    image: "https://api.dicebear.com/7.x/identicon/svg?seed=HONK",
    price: 0.000018,
    change1h: -2.40,
    change24h: 45.10,
    volume24h: 92400,
    ...
    buySellRatio: 0.58,
    holdersGrowth: 12.5,
    initialLiquidity: 45000,
    devWallet: "EQD_Honk_Dev_Clown_1209",
    launchTime: Date.now() - 35 * 60 * 1000, // 35 mins ago
    category: "Meme",
    logoBg: "linear-gradient(135deg, #ef4444, #991b1b)",
    socialLinks: { telegram: "https://t.me/honk_ton", x: "https://x.com/honk_ton", website: "https://honkler.xyz" },
    liquidity: 68000,
    supply: 5000000000,
    holders: 1940,
    security: { rugScore: 12, rugRisk: "Low Risk", verified: true, renounced: false, lockedLiquidity: 85 },
    decimals: 9,
    launchpad: "Gaspump",
    isLaunchpadToken: true,
    bondingProgress: 84,
    isDex: false,
    description: "Clown-themed meme token building its bonding curve on Gaspump."
  }
};
